...
model = tf.keras.models.load_model('C:/Users/chakr/Desktop/mini_project/model_casia_run1.h5')
...
# Streamlit app
def main():
    st.set_page_config(page_title='Image Forgery Detection', page_icon='C:/Users/chakr/Desktop/mini_project/logo.png')
